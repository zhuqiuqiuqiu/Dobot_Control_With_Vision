...
```bash
python train.py --img 640 --epochs 3 --label coco128.yaml --weights yolov5s.pt
```
...
python train.py --img 640 --epochs 3 --label coco128.yaml --weights yolov5s.pt  # 3. train
```
...
4. **Train the Model**:
    ```bash
    python train.py --img 640 --epochs 3 --label dataset.yaml --weights yolov5s.pt
    ```
