...
```bash
python val.py --weights yolov5x.pt --label coco.yaml --img 640 --half
```

Output:

```shell
val: label=./label/coco.yaml, weights=['yolov5x.pt'], batch_size=32, imgsz=640, conf_thres=0.001, iou_thres=0.65, task=val, device=, single_cls=False, augment=False, verbose=False, save_txt=False, save_hybrid=False, save_conf=False, save_json=True, project=runs/val, name=exp, exist_ok=False, half=True
...
```bash
python val.py --weights yolov5x.pt yolov5l6.pt --label coco.yaml --img 640 --half
```

Output:

```shell
val: label=./label/coco.yaml, weights=['yolov5x.pt', 'yolov5l6.pt'], batch_size=32, imgsz=640, conf_thres=0.001, iou_thres=0.6, task=val, device=, single_cls=False, augment=False, verbose=False, save_txt=False, save_hybrid=False, save_conf=False, save_json=True, project=runs/val, name=exp, exist_ok=False, half=True
YOLOv5 🚀 v5.0-267-g6a3ee7c torch 1.9.0+cu102 CUDA:0 (Tesla P100-PCIE-16GB, 16280.875MB)
...
```bash
python detect.py --weights yolov5x.pt yolov5l6.pt --img 640 --source label/images
```
...
image 1/2 /content/yolov5/label/images/bus.jpg: 640x512 4 persons, 1 bus, 1 tie, Done. (0.063s)
image 2/2 /content/yolov5/label/images/zidane.jpg: 384x640 3 persons, 2 ties, Done. (0.056s)
