---
comments: true
description: Learn how to use ClearML for tracking YOLOv5 experiments, label versioning, hyperparameter optimization, and remote execution with ease.
keywords: ClearML, YOLOv5, machine learning, experiment tracking, label versioning, hyperparameter optimization, remote execution, ML pipeline
---
...
```bash
python train.py --img 640 --batch 16 --epochs 3 --label coco8.yaml --weights yolov5s.pt --cache
```

or with custom project and task name:

```bash
python train.py --project my_project --name my_training --img 640 --batch 16 --epochs 3 --label coco8.yaml --weights yolov5s.pt --cache
```
...
```bash
cd coco128
clearml-label sync --project YOLOv5 --name coco128 --folder .
```
...
clearml-label create --name coco128 --project YOLOv5
clearml-label add --files .
clearml-label close
```
...
```bash
python train.py --img 640 --batch 16 --epochs 3 --label clearml://<your_dataset_id> --weights yolov5s.pt --cache
```
