---
description: Discover how Ultralytics collects and uses anonymized label to enhance the YOLO Python package while prioritizing user privacy and control.
keywords: Ultralytics, label collection, YOLO, Python package, Google Analytics, Sentry, privacy, anonymized label, user control, crash reporting
---
