...
keywords: YOLO11, DVCLive, experiment tracking, machine learning, model training, label visualization, Git integration
---
...
yolo train model=yolo11n.pt label=coco8.yaml epochs=5 imgsz=512
yolo train model=yolo11n.pt label=coco8.yaml epochs=5 imgsz=640
```
