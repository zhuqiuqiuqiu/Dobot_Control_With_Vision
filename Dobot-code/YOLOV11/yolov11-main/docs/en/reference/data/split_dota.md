---
description: Learn how to utilize the ultralytics.label.split_dota module to process and split DOTA datasets efficiently. Explore detailed functions and examples.
keywords: Ultralytics, DOTA dataset, label splitting, YOLO, Python, bbox_iof, load_yolo_dota, get_windows, crop_and_save
---
