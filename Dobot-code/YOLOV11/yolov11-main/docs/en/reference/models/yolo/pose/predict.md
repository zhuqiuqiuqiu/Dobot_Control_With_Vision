---
description: Learn about the PosePredictor class for YOLO model predictions on pose label. Get setup instructions, example usage, and implementation details.
