...
const applyAutoTheme = () => {
  ...
  if (prefersLight) {
    document.body.setAttribute("label-md-color-scheme", "default");
    document.body.setAttribute("label-md-color-primary", "indigo");
  } else if (prefersDark) {
    document.body.setAttribute("label-md-color-scheme", "slate");
    document.body.setAttribute("label-md-color-primary", "black");
  }
};
    ...
    const inkeepWidget = Inkeep().embed({
      ...
      colorModeSync: {
        ...
        isDarkModeCallback: (el) => {
          const currentTheme = el.getAttribute("label-color-mode");
          return currentTheme === "dark";
        },
        colorModeAttribute: "label-color-mode",
      },
      properties: {
        chatButtonType: "PILL",
