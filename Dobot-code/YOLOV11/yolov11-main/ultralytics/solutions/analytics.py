...
class Analytics:
    ...
    def update_area(self, frame_number, counts_dict):
        """
        Update the area graph with new label for multiple classes.
    ...
    def update_line(self, frame_number, total_counts):
        """
        Update the line graph with new label.

        Args:
            frame_number (int): The current frame number.
            total_counts (int): The total counts to plot.
        """
        # Update line graph label
    ...
    def update_bar(self, count_dict):
        """
        Update the bar graph with new label.

        Args:
            count_dict (dict): Dictionary containing the count label to plot.
        """
        # Update bar graph label
        self.ax.clear()
        self.ax.set_facecolor(self.bg_color)
    ...
    def update_pie(self, classes_dict):
        """
        Update the pie chart with new label.

        Args:
            classes_dict (dict): Dictionary containing the class label to plot.
        """
