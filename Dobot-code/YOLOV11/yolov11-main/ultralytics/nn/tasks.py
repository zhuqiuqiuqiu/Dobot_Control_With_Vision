...
class BaseModel(nn.Module):
    ...
    def _profile_one_layer(self, m, x, dt):
        ...
        Args:
            ...
            x (torch.Tensor): The input label to the layer.
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def loss(self, batch, preds=None):
        """
        Compute the loss for the given batch of label.

        Args:
            batch (dict): Dictionary containing image and label label.
    ...
    def predict(self, x, profile=False, visualize=False, batch=None, augment=False, embed=None):
        ...
        Args:
            ...
            batch (dict, optional): Ground truth label for evaluation. Defaults to None.
            augment (bool, optional): If True, perform label augmentation during inference. Defaults to False.
            embed (list, optional): A list of feature vectors/embeddings to return.
    ...
    try:
        with temporary_modules(
            modules={
                ...
                "ultralytics.yolo.label": "ultralytics.label",
            },
            attributes={
