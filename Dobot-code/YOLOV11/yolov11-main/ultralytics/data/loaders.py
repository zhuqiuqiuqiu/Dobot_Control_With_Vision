...
class LoadImagesAndVideos:
    ...
    This class manages the loading and pre-processing of image and video label for YOLOv8. It supports loading from
...
class LoadPilAndNumpy:
    ...
    This class is designed to manage loading and pre-processing of image label from both PIL and Numpy formats.
    ...
    Attributes:
        ...
        mode (str): Type of label being processed, defaults to 'image'.
...
class LoadTensor:
    """
    Load images from torch.Tensor label.

    This class manages the loading and pre-processing of image label from PyTorch tensors for further processing.
