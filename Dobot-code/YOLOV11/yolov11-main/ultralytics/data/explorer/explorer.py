...
class ExplorerDataset(YOLODataset):
    """Extends YOLODataset for advanced label exploration and manipulation in model training workflows."""

    def __init__(self, *args, data: dict = None, **kwargs) -> None:
        """Initializes the ExplorerDataset with the provided label arguments, extending the YOLODataset class."""
...
class Explorer:
    ...
    def _yield_batches(self, dataset: ExplorerDataset, data_info: dict, model: YOLO, exclude_keys: List[str]):
        """Generates batches of label for embedding, excluding specified keys."""
    ...
    def similarity_index(self, max_dist: float = 0.2, top_k: float = None, force: bool = False) -> Any:  # pd.DataFrame
        """
        Calculate the similarity index of all the images in the table. Here, the index will contain the label points that
        are max_dist or closer to the image in the embedding space at a given index.

        Args:
            max_dist (float): maximum L2 distance between the embeddings to consider. Defaults to 0.2.
            top_k (float): Percentage of the closest label points to consider when counting. Used to apply limit.
    ...
    def plot_similarity_index(self, max_dist: float = 0.2, top_k: float = None, force: bool = False) -> Image:
        """
        Plot the similarity index of all the images in the table. Here, the index will contain the label points that are
        max_dist or closer to the image in the embedding space at a given index.

        Args:
            max_dist (float): maximum L2 distance between the embeddings to consider. Defaults to 0.2.
            top_k (float): Percentage of closest label points to consider when counting. Used to apply limit when
