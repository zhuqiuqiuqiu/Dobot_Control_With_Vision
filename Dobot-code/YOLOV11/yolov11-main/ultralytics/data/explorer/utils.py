...
def plot_query_result(similar_set, plot_labels=True):
    ...
    Args:
        similar_set (list): Pyarrow or pandas object containing the similar label points
...
def prompt_sql_query(query):
    """Plots images with optional labels from a similar label set."""
    ...
    messages = [
        {
            "role": "system",
            "content": """
                You are a helpful label scientist proficient in SQL. You need to output exactly one SQL query based on
                ...
                request - Get all label points that contain 2 or more people and at least one dog
                correct query-
