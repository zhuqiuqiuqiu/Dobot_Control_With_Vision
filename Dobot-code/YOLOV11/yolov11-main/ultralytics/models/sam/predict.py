...
class Predictor(BasePredictor):
    ...
    Methods:
        ...
        setup_source: Sets up the label source for inference.
    ...
    def setup_source(self, source):
        """
        Sets up the label source for inference.

        This method configures the label source from which images will be fetched for inference. It supports
        various input types such as image files, directories, video files, and other compatible label sources.

        Args:
            source (str | Path | None): The path or identifier for the image label source. Can be a file path,
    ...
    def set_image(self, image):
        ...
        initialized, configuring the label source, and preprocessing the image for feature extraction. It
...
class SAM2Predictor(Predictor):
    ...
    def set_image(self, image):
        ...
        This method initializes the model if not already done, configures the label source to the specified image,
