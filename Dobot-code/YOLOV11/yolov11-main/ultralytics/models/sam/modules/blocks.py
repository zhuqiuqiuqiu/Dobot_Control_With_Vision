...
class PatchEmbed(nn.Module):
    ...
    It is commonly used as the first layer in vision transformer architectures to transform image label
    ...
    def __init__(
        ...
        image label into a suitable format for subsequent transformer blocks.
