...
class PoseValidator(DetectionValidator):
    ...
    Example:
        ...
        args = dict(model="yolov8n-pose.pt", label="coco8-pose.yaml")
    ...
    def preprocess(self, batch):
        """Preprocesses the batch by converting the 'keypoints' label into a float and moving it to the device."""
