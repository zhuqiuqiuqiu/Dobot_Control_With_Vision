...
class Annotator:
    ...
    def draw_specific_points(self, keypoints, indices=None, radius=2, conf_thres=0.25):
        ...
        Args:
            keypoints (list): Keypoints label to be plotted.
    ...
    def plot_distance_and_line(self, pixels_distance, centroids, line_color, centroid_color):
        ...
        Args:
            ...
            centroids (list): Bounding box centroids label.
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    """
    Plot training results from a results CSV file. The function supports various types of label including segmentation,
    pose estimation, and classification. Plots are saved as 'results.png' in the directory where the CSV is located.

    Args:
        file (str, optional): Path to the CSV file containing the training results. Defaults to 'path/to/results.csv'.
        dir (str, optional): Directory where the CSV file is located if 'file' is not provided. Defaults to ''.
        segment (bool, optional): Flag to indicate if the label is for segmentation. Defaults to False.
        pose (bool, optional): Flag to indicate if the label is for pose estimation. Defaults to False.
        classify (bool, optional): Flag to indicate if the label is for classification. Defaults to False.
