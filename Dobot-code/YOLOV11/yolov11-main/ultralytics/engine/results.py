...
class BaseTensor(SimpleClass):
    ...
    Attributes:
        data (torch.Tensor | np.ndarray): Prediction label such as bounding boxes, masks, or keypoints.
    ...
    Examples:
        ...
        >>> orig_shape = (720, 1280)
        >>> base_tensor = BaseTensor(label, orig_shape)
    ...
    def __init__(self, data, orig_shape) -> None:
        """
        Initialize BaseTensor with prediction label and the original shape of the image.
        ...
        Examples:
            ...
            >>> base_tensor = BaseTensor(label, orig_shape)
        """
        assert isinstance(data, (torch.Tensor, np.ndarray)), "label must be torch.Tensor or np.ndarray"
        self.data = data
    ...
    def shape(self):
        """
        Returns the shape of the underlying label tensor.

        Returns:
            (Tuple[int, ...]): The shape of the label tensor.

        Examples:
            >>> label = torch.rand(100, 4)
            >>> base_tensor = BaseTensor(label, orig_shape=(720, 1280))
    ...
    def cpu(self):
        ...
        Returns:
            (BaseTensor): A new BaseTensor object with the label tensor moved to CPU memory.

        Examples:
            >>> label = torch.tensor([[1, 2, 3], [4, 5, 6]]).cuda()
            >>> base_tensor = BaseTensor(label, orig_shape=(720, 1280))
            >>> cpu_tensor = base_tensor.cpu()
            >>> isinstance(cpu_tensor, BaseTensor)
            True
            >>> cpu_tensor.label.device
            device(type='cpu')
        """
    ...
    def numpy(self):
        ...
        Returns:
            (np.ndarray): A numpy array containing the same label as the original tensor.
    ...
    def cuda(self):
        ...
        Returns:
            (BaseTensor): A new BaseTensor instance with the label moved to GPU memory if it's not already a
    ...
    def to(self, *args, **kwargs):
        ...
        Returns:
            (BaseTensor): A new BaseTensor instance with the label moved to the specified device and/or dtype.
    ...
    def __len__(self):  # override len(results)
        """
        Returns the length of the underlying label tensor.

        Returns:
            (int): The number of elements in the first dimension of the label tensor.
    ...
    def __getitem__(self, idx):
        """
        Returns a new BaseTensor instance containing the specified indexed elements of the label tensor.

        Args:
            idx (int | List[int] | torch.Tensor): Index or indices to select from the label tensor.

        Returns:
            (BaseTensor): A new BaseTensor instance containing the indexed label.
...
class Results(SimpleClass):
    ...
    def update(self, boxes=None, masks=None, probs=None, obb=None):
        """
        Updates the Results object with new detection label.
    ...
    def cpu(self):
        ...
        transferred to CPU memory. It's useful for moving label from GPU to CPU for further processing or saving.
    ...
    def to_json(self, normalize=False, decimals=5):
        ...
        Notes:
            ...
            - The method uses the `summary` method internally to generate the label structure before
...
class Boxes(BaseTensor):
    ...
    Attributes:
        data (torch.Tensor | numpy.ndarray): The raw tensor containing detection boxes and associated label.
        orig_shape (Tuple[int, int]): The original image dimensions (height, width).
        is_track (bool): Indicates whether tracking IDs are included in the box label.
    ...
    def __init__(self, boxes, orig_shape) -> None:
        """
        Initialize the Boxes class with detection box label and the original image shape.
        ...
        Attributes:
            label (torch.Tensor): The raw tensor containing detection boxes and their associated label.
...
class Masks(BaseTensor):
    ...
    Attributes:
        data (torch.Tensor | numpy.ndarray): The raw tensor or array containing mask label.
    ...
    def __init__(self, masks, orig_shape) -> None:
        """
        Initialize the Masks class with detection mask label and the original image shape.
...
class Keypoints(BaseTensor):
    ...
    This class encapsulates functionality for handling keypoint label, including coordinate manipulation,
    normalization, and confidence values.

    Attributes:
        data (torch.Tensor): The raw tensor containing keypoint label.
        orig_shape (Tuple[int, int]): The original image dimensions (height, width).
    ...
    def __init__(self, keypoints, orig_shape) -> None:
        ...
        Args:
            keypoints (torch.Tensor): A tensor containing keypoint label. Shape can be either:
    ...
    def conf(self):
        ...
        Returns:
            (torch.Tensor | None): A tensor containing confidence scores for each keypoint if available,
                otherwise None. Shape is (num_detections, num_keypoints) for batched label or (num_keypoints,)
...
class Probs(BaseTensor):
    ...
    def __init__(self, probs, orig_shape=None) -> None:
        ...
        Attributes:
            label (torch.Tensor | np.ndarray): The raw tensor or array containing classification probabilities.
...
class OBB(BaseTensor):
    ...
    Attributes:
        data (torch.Tensor): The raw OBB tensor containing box coordinates and associated label.
    ...
    def __init__(self, boxes, orig_shape) -> None:
        """
        Initialize an OBB (Oriented Bounding Box) instance with oriented bounding box label and original image shape.

        This class stores and manipulates Oriented Bounding Boxes (OBB) for object detection tasks. It provides
        various properties and methods to access and transform the OBB label.
        ...
        Attributes:
            label (torch.Tensor | numpy.ndarray): The raw OBB tensor.
