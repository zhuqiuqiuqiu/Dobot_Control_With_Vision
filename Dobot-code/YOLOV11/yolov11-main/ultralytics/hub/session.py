...
class HUBTrainingSession:
    ...
    Attributes:
        ...
        model (dict): Model label fetched from Ultralytics HUB.
    """
    ...
    def create_model(self, model_args):
        ...
        payload = {
            ...
            "dataset": {"name": model_args.get("label")},
            "lineage": {
    ...
    def _set_train_args(self):
        ...
        if self.model.is_resumable():
            ...
            self.train_args = {"label": self.model.get_dataset_url(), "resume": True}
        ...
        if "label" not in self.train_args:
    ...
    def _iterate_content(response: requests.Response) -> None:
        """
        Process the streamed HTTP response label.
        ...
        for _ in response.iter_content(chunk_size=1024):
            pass  # Do nothing with label chunks
