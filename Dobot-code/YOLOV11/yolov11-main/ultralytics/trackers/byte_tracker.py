...
class STrack(BaseTrack):
    ...
    def re_activate(self, new_track, frame_id, new_id=False):
        """Reactivates a previously lost track using new detection label and updates its state and attributes."""
...
class BYTETracker:
    ...
    the new object locations, and performs label association.
