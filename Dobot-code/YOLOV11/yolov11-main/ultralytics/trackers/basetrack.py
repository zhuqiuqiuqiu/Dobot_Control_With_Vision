...
class BaseTrack:
    ...
    Methods:
        ...
        update: Abstract method to update the track with new label.
    ...
    def update(self, *args, **kwargs):
        """Updates the track with new observations and label, modifying its state and attributes accordingly."""
        raise NotImplementedError
