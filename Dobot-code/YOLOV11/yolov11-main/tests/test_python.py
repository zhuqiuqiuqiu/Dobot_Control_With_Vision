...
@pytest.mark.skipif(not ONLINE, reason="environment is offline")
def test_data_utils():
    """Test utility functions in ultralytics/label/utils.py, including dataset stats and auto-splitting."""
...
def test_data_annotator():
    """Automatically annotate label using specified detection and segmentation models."""
