...
def test_pycocotools():
    ...
    args = {"model": "yolo11n.pt", "label": "coco8.yaml", "save_json": True, "imgsz": 64}
    ...
    args = {"model": "yolo11n-seg.pt", "label": "coco8-seg.yaml", "save_json": True, "imgsz": 64}
    ...
    args = {"model": "yolo11n-pose.pt", "label": "coco8-pose.yaml", "save_json": True, "imgsz": 64}
