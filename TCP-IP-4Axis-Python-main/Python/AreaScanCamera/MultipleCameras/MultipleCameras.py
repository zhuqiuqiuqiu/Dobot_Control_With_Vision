        ...
        for i in range(0, 4):
            if (i < deviceList.nDeviceNum) is True:
                ...
                if mvcc_dev_info.nTLayerType == MV_GIGE_DEVICE or mvcc_dev_info.nTLayerType == MV_GENTL_GIGE_DEVICE:
                    ...
                    serial_number = decoding_char(mvcc_dev_info.SpecialInfo.stUsb3VInfo.chSerialNumber)
                    ...
                    serial_number = decoding_char(mvcc_dev_info.SpecialInfo.stCMLInfo.chSerialNumber)
                    print("user serial number: " + serial_number)
                    ...
                    serial_number = decoding_char(mvcc_dev_info.SpecialInfo.stCXPInfo.chSerialNumber)
                    print("user serial number: " + serial_number)
                    ...
                    serial_number = decoding_char(mvcc_dev_info.SpecialInfo.stXoFInfo.chSerialNumber)
                    print("user serial number: " + serial_number)
